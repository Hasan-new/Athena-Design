...
import face from '../../images/happy@2x.png'
    ...
    return (
        <div className="achievements">
            <div className="container d-flex align-items-center inside_achievments">
                <div className="col-lg-5 col-md-12 col-sm-12 achievements-left">
                ...
                <div className="col-lg-7 col-md-12 col-sm-12 d-flex flex-wrap achievements-right">
